...
- `npm run verify:quality-gates:integrity`: passed with 0 integrity failures
- `npm run verify:quality-gates:determinism`: passed with matching hashes
- Determinism hash: `645ef86ec8d4ce21eaa40bcff1cf385208a247d9713e5a257b0e8e89f4cb8c16`

## Accepted Staging Debt

- Batch 0 warning in [staging/schemas/batch0-foundation/manifest.json](staging/schemas/batch0-foundation/manifest.json)
...
- Batch 5 warning in [staging/schemas/batch5-propulsion-steering/manifest.json](staging/schemas/batch5-propulsion-steering/manifest.json)
