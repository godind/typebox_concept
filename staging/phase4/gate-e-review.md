...
- Batch 0 warning in [staging/phase3/batch0-foundation/manifest.json](staging/phase3/batch0-foundation/manifest.json)
...
- Batch 5 warning in [staging/phase3/batch5-propulsion-steering/manifest.json](staging/phase3/batch5-propulsion-steering/manifest.json)
